...
Note: This project is using [windows-beacon-library](https://github.com/AltBeacon/windows-beacon-library) by [davidgyoung](https://github.com/AltBeacon/windows-beacon-library/commits?author=davidgyoung)
